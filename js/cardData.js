...
window.CardData = (() => {
  ...
  const RUNES = [
    { name:"Fehu",     number:"1",  element:"Fire",  astro:"Venus",   section:"Runes", imageName:null,
      upright:"Wealth, abundance, prosperity, luck, success, cattle",
      reversed:"Loss, greed, stagnation, discord over money" },
    { name:"Uruz",     number:"2",  element:"Earth", astro:"Taurus",  section:"Runes", imageName:null,
